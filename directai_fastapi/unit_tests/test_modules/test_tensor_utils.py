...
class TestBatchEncodeCacheMissedListElements(unittest.TestCase):
    def test_batch_encode_cache_missed_list_elements(self) -> None:
        ...
        output_tensor = batch_encode_cache_missed_list_elements(encode_fn, args_list, cache)
        ...
        new_output_tensor = batch_encode_cache_missed_list_elements(encode_fn, new_args_list, cache)
